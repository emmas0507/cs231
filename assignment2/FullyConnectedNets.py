...
################################################################################
# # todo, begin of comment for two layer neural network
...
# # ----------------- set parameters -------------------------------------------
# param_dict = {}
# param_dict['num_train_samples'] = data['X_train'].shape[0]
# param_dict['batch_size'] = 3000
# param_dict['optim_config'] = {'learning_rate': 3e-3}
# param_dict['lr_decay'] = 0.99
# param_dict['print_every'] = 1
# param_dict['num_epochs'] = 100
#
# # ----------------- set model ------------------------------------------------
# D = np.prod(data['X_train'].shape[1:])
# print('input dimension: {}'.format(D))
# H = 1000  # dimension of hidden layers
# C = len(set(data['y_train']))
# print(C)
# std = 1e-4
# reg = 0.03
...
#
# # ----------------- set up solver --------------------------------------------
# solver = Solver(model, data, **param_dict)
# solver.train()
##############################################################################
#                             END OF YOUR CODE                               #
##############################################################################
...
# # plt.show()
# plt.savefig('./reports/history.png')

###############################################################################
# # todo, end of comment for two layer neural network
...
plt.savefig('./reports/three_layers_50.png')
...
plt.xlabel('Iteration')
plt.ylabel('Training loss')
plt.savefig('./reports/five_layers_50.png')
...
plt.savefig('./reports/sdg_momentum.png')
...
for i in [1, 2, 3]:
  ...
  plt.legend(loc='upper center', ncol=4)
plt.gcf().set_size_inches(15, 15)
plt.savefig('./reports/adam_rmsprop.png')

...
# 
# As fun way to both check your implementation and gain a better understanding of the type of operation that convolutional layers can perform,
# we will set up an input containing two images and manually set up filters that perform common image processing operations (grayscale conversion and edge detection).
...
imshow_noax(out[1, 1])
# plt.show()
plt.savefig('./reports/kitten_puppies.png')
...
# Note: correct implementations may still have relative errors up to 1e-2.
...
# plt.xlabel('epoch')
# plt.ylabel('accuracy')
# plt.savefig('./reports/small_conv_overfit.png')
...
# plt.savefig('./reports/conv_first_layer.png')
